  ...
  return m('form.my-5', {
    ...
    m('.container',
      m('.row.justify-content-center',
        inputField,
        m('.col-md-2',
          m('button.btn.btn-primary', { type: 'submit' }, 'Actualizar'))))
  ])
}
...
const PropertyDetailPage = {
  ...
  view (vnode) {
    ...
    return [
      ...
      m('.container',
        layout.row([
          m('h5.mr-auto', 'Actualizar historial'),
          m(PagingButtons, {
        ...
        m(Table, {
          ...
          noRowsText: 'Esta propiedad nunca ha sido actualizada'
        }))
    ]
  }
}
