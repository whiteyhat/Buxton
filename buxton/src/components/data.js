      ...
      return api.get('info')
        .then(({ mapsApiKey }) => {
          ...
          return modals.show(modals.BasicModal, {
            ...
            acceptText: 'Añadir clave',
            body: m('.container', [
              m('.mb-4',
                'Oh no! El servidor no ha sido configurado con una clave API',
                  ' para usar Google Maps. Puedes añadir una ',
                m('en', {
                  href: 'https://developers.google.com/maps/documentation/javascript/get-api-key',
                  target: '_blank'
                }, ' solicita una clave gratuitade desarrollador en Google'),
                ' y escribela debajo.'),
